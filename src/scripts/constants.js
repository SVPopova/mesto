...
const popupFigcaption = popupFigure.querySelector('.popup__text');
  ...
  export { initialCards, obj, nameProfile, aboutProfile, buttonEdit, buttonAdd, formElementAdd, formElementEdit, popupButtonSave, nameInput, jobInput, titleInput, linkInput, cardsContainer, popupImage, popupFigcaption };